    ...
    <footer className="footer" style={{ backgroundImage: `url(${image})` }}>
      <div className="footer-container">
        ...
        <div className="footer-card">
          ...
          <ul>
            <li>
              <a href="/terms">Sözleşmeler ve Kurallar</a>
            </li>
            <li>
              <a href="/account-terms">Hesap Sözleşmesi</a>
            </li>
            <li>
              <a href="/privacy">Kişisel Verilerin Korunması</a>
            </li>
            <li>
              <a href="/help">Yardım Rehberi</a>
            </li>
            <li>
              <a href="/email">Email İşlemleri</a>
            </li>
          </ul>
        </div>
        ...
        <div className="footer-card">
          ...
          <ul>
            <li>
              <a href="/history">Tarihçe</a>
            </li>
            <li>
              <a href="/dedications">İthaflar</a>
            </li>
            <li>
              <a href="/application">Uygulama</a>
            </li>
            <li>
      ...
      <div className="footer-bottom">
        <p>© {new Date().getFullYear()} CarShop | Gürkan Kadıoğlu</p>
      </div>
    </footer>
  );
}
